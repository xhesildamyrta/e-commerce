...
<div class="bg-blue-50 border-t border-b border-blue-500 text-blue-700 px-4 py-3" role="alert" id="alert">
    <p class="font-bold text-center"> {{ session()->get('success_message') }}</p>
</div>
@endif
        ...
        <form method="POST" action="{{ route('login.user') }}">
            ...
            <div class="mt-4">
                <div>
                    ...
                    <input type="text" placeholder="Email" id="email" name="email" class="form-control w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-pink-300" required autofocus>
                    @if ($errors->has('email'))
