<div class="flex flex-col place-items-center group">
    <div class="px-0.5 py-0.5 sm:px-10 sm:py-5 h-64 grid place-items-center hover:border-red-500 border-transparent border-l-4 hover:border-current" style="background-color: #F6F7FB;box-shadow: 0px 8px 40px rgba(49, 32, 138, 0.05); border-radius:50%;">
