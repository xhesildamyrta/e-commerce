<div class="flex flex-col place-items-center group">
    <div class="rounded-full px-10 py-5 grid place-items-center hover:border-purple-500 border-transparent border-l-4 hover:border-current" style="background-color: #F6F7FB;box-shadow: 0px 8px 40px rgba(49, 32, 138, 0.05);">
