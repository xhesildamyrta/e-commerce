<div class="flex flex-col">
            <div class="img-wrapper">
                <div class="flex pt-3 pl-3 space-x-2 lg:space-x-5 place-items-center">
                ...
                <div class="grid place-items-center px-3 pt-4 lg:px-16 lg:pt-8 pb-3">
                    <img src="{{$imgSrc}}" class="object-center">
                    <button class="viewDetail-btn py-2 px-1 text-white text-sm text-center">View Details</button>
                </div>
                
            </div>
            <div class="content-wrapper text-center space-y-1 sm:space-y-3" style="box-shadow: 0px 0px 25px rgba(0, 0, 0, 0.1);">
